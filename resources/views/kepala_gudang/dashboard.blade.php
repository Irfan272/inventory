...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 ">
        {{-- <a href="/kepala_gudang/barang_masuk/create" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Input Data
          Barang Masuk</a> --}}
        <div class="x_panel">
          <div class="x_title">
...
{{-- 
                  <td style="text-align: left">
                    <a href="/admin/barang_masuk/view/{{ $s->id }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
