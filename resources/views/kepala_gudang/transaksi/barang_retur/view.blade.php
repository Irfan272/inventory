            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form action="/admin/retur/update/{{ $retur->id }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_retur" readonly id="tanggal_retur" class="form-control" value="{{ $retur->tanggal_retur }}" required>
                            </div>
                            ...
                            <a href="/kepala_gudang/barang_retur" class="btn btn-danger">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
