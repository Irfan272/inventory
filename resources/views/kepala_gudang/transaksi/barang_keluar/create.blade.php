                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" name="harga" id="hargaInput" class="form-control" min="1" required></td>
                                        <td>
   ...
   $('#barangSelect').on('change', function() {
    ...
    if (barangId !== '') {
        ...
        document.getElementById('addRow').addEventListener('click', function() {
            var row = '<tr>' +
                '<td><select name="id_barang[]" class="form-control selectpicker" data-live-search="true">' +
                '<option value="">Pilih Produk</option>' +
                '@foreach($barang as $product)' +
                ...
                '</select></td>' +
                '<td><input type="number" name="jumlah[]" class="form-control" min="1" required></td>' +
                '<td><input type="text" name="satuan" class="form-control" readonly required></td>' +
