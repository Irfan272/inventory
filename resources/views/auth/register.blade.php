                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <select name="jenis_kelamin" id="jenis_kelamin"  value="{{old('jenis_kelamin')}}" class="form-control @error('name') is-invalid @enderror">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <select name="role" id="role"  value="{{old('role')}}" class="form-control @error('role') is-invalid @enderror">
