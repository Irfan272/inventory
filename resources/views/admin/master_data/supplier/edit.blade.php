                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="" action="/admin/supplier/update/{{ $e->id }}" method="post" novalidate>
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ $e->kd_supplier }}" class="@error('kd_supplier') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="kd_supplier" required="required" />
                                        @error('kd_supplier')
                                ...
                                <div class="field item form-group">                                    
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ $e->nama_supplier }}" class="@error('nama_supplier') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="nama_supplier" required="required" />
                                        @error('nama_supplier')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
