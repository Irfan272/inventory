...
@section('title', 'Edit Data Barang retur')
            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form action="/admin/barang_retur/update/{{ $retur->id }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_sales" id="id_sales" class="form-control" required>
                                    ...
                                    @foreach($sales as $sales)
                                        <option value="{{ $sales->id }}" {{ $retur->id_sales == $sales->id ? 'selected' : '' }}>
                                            {{ $sales->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label for="tanggal_pembelian">Tanggal retur:</label>
                                <input type="date" name="tanggal_retur" id="tanggal_retur" class="form-control" value="{{ $retur->tanggal_retur }}" required>
                            </div>
                            ...
                            <button type="submit" class="btn btn-success">Update Barang retur</button>
