...
class KepalaGudangController extends Controller
{
    ...
    public function dashboard(){
        ...
        return view('kepala_gudang.dashboard', compact('total_barangmasuk','total_barangkeluar','total_retur', 'barangmasuk', 'barangkeluar', 'retur' ));
    }

    public function indexBarangMasuk(){
        $barangmasuk = BarangMasuk::with('Supplier')->orderBy('tanggal_masuk', 'desc')->get();
        return view('kepala_gudang.transaksi.barang_masuk.index', compact('barangmasuk'));
    }
    ...
    public function createBarangMasuk(){
        ...
        return view('kepala_gudang.transaksi.barang_masuk.create', compact('supplier', 'barang', 'no_po'));
    }
    ...
    public function storeBarangMasuk(Request $request){
        ...
        return redirect('/kepala_gudang/barang_masuk')->with('status', 'Data berhasil ditambah.');
    }
    ...
    public function editBarangMasuk($id){
        ...
        return view('kepala_gudang.transaksi.barang_masuk.edit', compact('supplier', 'barang', 'barangmasuk', 'pembelianBarang'));
    }
    ...
    public function updateBarangMasuk(Request $request, $id) {
        ...
        return redirect('/kepala_gudang/barang_masuk')->with('success', 'Transaksi barang masuk berhasil diubah.');
    }
    ...
    public function viewBarangMasuk($id){
        ...
        return view('kepala_gudang.transaksi.barang_masuk.view', compact('supplier', 'barang', 'barangmasuk', 'pembelianBarang'));
    }

    public function deleteBarangMasuk($id) {
        BarangMasuk::destroy($id);
        return redirect('/kepala_gudang/barang_masuk')->with('status', 'Data berhasil dihapus.');
    }
    ...
    public function indexBarangKeluar(){
        ...
        return view('kepala_gudang.transaksi.barang_keluar.index', compact('barangkeluar'));
    }
    ...
    public function createBarangKeluar(){
        ...
        $barang = Barang::all();
        $no_po = $this->generate_unique_no_po();
        return view('kepala_gudang.transaksi.barang_keluar.create', compact('sales', 'barang', 'no_po'));
    }
    ...
    public function storeBarangKeluar(Request $request){
        ...
        return redirect('/kepala_gudang/barang_keluar')->with('status', 'Data berhasil ditambah.');
    }
    ...
    public function editBarangKeluar($id){
        ...
        return view('kepala_gudang.transaksi.barang_keluar.edit', compact('sales', 'barang', 'barangkeluar', 'pembelianBarang'));
    }
    ...
    public function updateBarangKeluar(Request $request, $id) {
        ...
        return redirect('/kepala_gudang/barang_keluar')->with('success', 'Transaksi barang keluar berhasil diubah.');
    }
    ...
    public function viewBarangKeluar($id){
        ...
        return view('kepala_gudang.transaksi.barang_keluar.view', compact('sales', 'barang', 'barangkeluar', 'pembelianBarang'));
    }

    public function delete($id) {
        BarangKeluar::destroy($id);
        return redirect('/kepala_gudang/pembelian')->with('status', 'Data berhasil dihapus.');
    }
    ...
    public function indexBarangRetur(){
        ...
        return view('kepala_gudang.transaksi.barang_retur.index', compact('retur'));
    }
    ...
    public function createBarangRetur(){
        ...
        return view('kepala_gudang.transaksi.barang_retur.create', compact('sales', 'barang', 'no_retur'));
    }
    ...
    public function storeBarangRetur(Request $request){
        ...
        return redirect('/kepala_gudang/barang_retur')->with('status', 'Data berhasil ditambah.');
    }
    ...
    public function editBarangRetur($id){
        ...
        return view('kepala_gudang.transaksi.barang_retur.edit', compact('sales', 'barang', 'retur', 'pembelianBarang'));
    }
    ...
    public function updateBarangRetur(Request $request, $id) {
        ...
        return redirect('/kepala_gudang/barang_retur')->with('success', 'Transaksi barang retur berhasil diubah.');
    }
    ...
    public function viewBarangRetur($id){
        ...
        return view('kepala_gudang.transaksi.barang_retur.view', compact('sales', 'barang', 'retur', 'pembelianBarang'));
    }

    public function deleteBarangRetur($id) {
        Retur::destroy($id);
        return redirect('/kepala_gudang/barang_retur')->with('status', 'Data berhasil dihapus.');
    }
    ...
    public function cetakBarang(){
        $barang = Barang::all();
        return view('kepala_gudang.laporan.cetak-barang', compact('barang'));
    }
    ...
    public function cetakBarangDetail($nama_barang){
        ...
        // dd([$cetakRiwayat]);
        return view('kepala_gudang.laporan.cetak-barang-detail', compact('cetakBarang', 'cetakBarang'));
    }

    public function cetakBarangMasuk(){
        return view('kepala_gudang.laporan.cetak-barang-masuk');
    }
    public function cetakBarangMasukPertanggal($tanggal_awal, $tanggal_akhir){
        ...
        return view('kepala_gudang.laporan.cetak-barang-masuk-detail', compact('cetakBarangMasuk', 'total', 'tanggal_mulai', 'tanggal_terakhir', 'tanggal_cetak'));
    }

    public function cetakBarangKeluar(){
        return view('kepala_gudang.laporan.cetak-barang-keluar');
    }
    public function cetakBarangKeluarPertanggal($tanggal_awal, $tanggal_akhir){
        ...
        return view('kepala_gudang.laporan.cetak-barang-keluar-detail', compact('cetakBarangKeluar', 'total', 'tanggal_mulai', 'tanggal_terakhir', 'tanggal_cetak'));
    }

    public function cetakBarangRetur(){
        return view('kepala_gudang.laporan.cetak-barang-retur');
    }
    public function cetakBarangReturPertanggal($tanggal_awal, $tanggal_akhir){
        ...
        return view('kepala_gudang.laporan.cetak-barang-retur-detail', compact('cetakBarangRetur', 'total', 'tanggal_mulai', 'tanggal_terakhir', 'tanggal_cetak'));
    }
